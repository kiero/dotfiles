...
# For desktop path, use `PfDe` and `file://${HOME}/Desktop/`
...
# Use AirDrop over every interface (e.g. ethernet). Enables it on unsupported Macs too
...
###############################################################################
# Dock, Dashboard, Mission Controll and hot corners                                            #
###############################################################################
...
# Speed up Launchpad scrolling animation
